...
const navList = [
  ...
  { title: "explorers", icon: <HiOutlineUsers />, position: 2.1 },
  { title: "roadmap", icon: <HiOutlineChip />, position: 6.7 },
  { title: "sneak peak", icon: <HiOutlineDesktopComputer />, position: 7.8 },
  { title: "socials", icon: <HiOutlineCollection />, position: 9 },
];
